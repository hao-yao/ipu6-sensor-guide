...
#define OV13B10_DGTL_GAIN_DEFAULT	1024	     /* Default gain = 1 X */
...
static const struct ov13b10_reg mode_1364x768_regs[] =
{
//@@ mode - RES_1364x768
//100 99 1364 768
//;----------------------------------------------
...
static const struct ov13b10_mode supported_modes[] = {
	...
	},
	{
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1364x768_regs),
			.regs = mode_1364x768_regs,
		},
		.link_freq_index = OV13B10_LINK_FREQ_INDEX_0,
	},
};
